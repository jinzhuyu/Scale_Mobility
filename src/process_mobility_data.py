...
# class MobilityData:
    ...
    def find_home_all_group(df):
        ...
        user_home_list = df.groupby('id_str').apply(lambda x: find_home_by_group(x))
    ...
    def process_all_date():
        ...
        folder_list = list(os.listdir(dir_raw_data))[:2]    #[-3:]
...
def main():
    ...
    mobility_data = MobilityData(dir_raw_data, dir_processed_data, is_save=False)
    t0 = time()
