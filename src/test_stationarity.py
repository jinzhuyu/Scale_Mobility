...
@author: Jin-Zhu Yu
"""
# Assume little knowledge is required ahead of time for readers to understand and run the code
...
def get_adf(pd_series):
    '''test the stationarity of time series using Augmented Dickey-Fuller (ADF), one of the unit root test methods.
